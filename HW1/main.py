...
policy, Q, R, R_cummulated = policy_tools.policy_optimization(env, epsilon=0.95)
policy_tools.compare_value_function(Q.max(axis=2), v_opt)
policy, Q, R, R_cummulated = policy_tools.policy_optimization(env, epsilon=0.90)
policy_tools.compare_value_function(Q.max(axis=2), v_opt)
policy, Q, R, R_cummulated = policy_tools.policy_optimization(env, epsilon=0.80)
policy_tools.compare_value_function(Q.max(axis=2), v_opt)
policy, Q, R, R_cummulated = policy_tools.policy_optimization(env, epsilon=0.75)
policy_tools.compare_value_function(Q.max(axis=2), v_opt)
